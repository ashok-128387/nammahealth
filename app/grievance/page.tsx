...
const sections = [
  {
    number: '1',
    title: 'Purpose',
    content: 'This policy establishes a transparent process for users to submit complaints or concerns and receive timely resolution. It ensures grievances are addressed professionally, efficiently, and accountably.',
  },
  {
    number: '2',
    title: 'Scope',
  ...
  },
  {
    ...
    content: 'Responsible for overseeing complaint handling and ensuring timely resolution.',
  },
  {
    number: '7',
    title: 'Escalation Process',
    content: 'If unsatisfied with the support response, escalate to the Grievance Officer. Include original complaint details, reference number, and reason for escalation.',
    note: '7A. Frivolous or Misleading Complaints: Namma Health may reject complaints that are frivolous, malicious, misleading, or lacking sufficient information. Repeated misuse may lead to suspension or termination of membership.',
  },
  {
    number: '8',
    title: 'Limitation of Responsibility',
    content: 'Namma Health operates as a coordination platform and is not responsible for grievances related to medical treatment, diagnostic accuracy, hospital services, or billing disputes. Such concerns must be addressed directly with the respective provider.',
  },
  {
    number: '9',
    title: 'Unresolved Matters',
    content: "If a grievance remains unresolved, it may be escalated or resolved according to Namma Health's governing law and dispute resolution policies.",
  },
  {
    number: '10',
    title: 'Record Keeping',
    content: "All grievances and resolutions may be documented for internal review, service improvement, and legal compliance. User information will be processed in accordance with Namma Health's Privacy Policy.",
  },
  {
    number: '11',
    title: 'Policy Updates',
    content: 'Namma Health may modify this policy to reflect operational or legal changes. Updated versions will be published on the website with a revised effective date.',
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-14" style={{ backgroundColor: 'rgb(25, 165, 164)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-5xl font-bold text-white mb-4">Grievance Redressal Policy</h1>
          <p className="text-white/90 text-lg max-w-2xl">
            Our commitment to resolving your concerns transparently and efficiently.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="p-6 rounded-2xl text-white" style={{ backgroundColor: 'rgb(25, 165, 164)' }}>
            <h2 className="text-lg font-bold mb-4">Submit a Grievance</h2>
